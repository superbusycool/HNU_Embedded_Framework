...
// 需定期校准后手动修改
#define GxOFFSET  0.0000038312f//0.00000110679f
#define GyOFFSET  0.00000553397058f//-0.00000229872f
#define GzOFFSET -0.000011493632f//-0.00000085138f
#define gNORM 9.79412937f//9.744925f
